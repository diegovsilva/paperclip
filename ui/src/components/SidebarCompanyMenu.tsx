    ...
    <DropdownMenu open={open} onOpenChange={setOpen}>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          aria-label={selectedCompany ? `Abrir menu de ${selectedCompany.name}` : "Abrir menu da empresa"}
        ...
        <DropdownMenuItem asChild>
          <Link to="/company/settings/invites" onClick={closeNavigationChrome}>
            ...
            <span className="truncate">
              {selectedCompany ? `Convidar pessoas para ${selectedCompany.name}` : "Convidar pessoas"}
            </span>
          </Link>
        </DropdownMenuItem>
        <DropdownMenuItem asChild>
        ...
        {session?.session ? (
          <>
            ...
            >
              ...
              <span>{signOutMutation.isPending ? "Saindo..." : "Sair"}</span>
            </DropdownMenuItem>
          </>
        ) : null}
      </DropdownMenuContent>
